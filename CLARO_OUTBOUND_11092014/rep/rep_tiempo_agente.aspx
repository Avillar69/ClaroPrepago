<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_tiempo_agente.aspx.vb" Inherits="rep_rep_porta" %>
...
<td><asp:DropDownList ID="cboServicio" runat="server" CssClass="form-control"></asp:DropDownList></td>
</tr>
</table>
</div>
...
<asp:LinkButton ID="lnkExportar1" runat="server" class="btn btn-default btn-sm" Visible="false" OnClick="ExportToExcel1" >
       ...
       <span class="glyphicon glyphicon-download-alt"></span> &nbsp; Exportar Registros
       </asp:LinkButton>
       <br />

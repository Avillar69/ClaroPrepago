<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="bloqueos_claro_3play_hfc.aspx.vb" Inherits="rep_rep_porta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <uc1:UCTitulo1 ID="UCTitulo11" runat="server" Titulo="Reporte por Bloquear Claro 3 Play OutBound HFC" />

<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="bloqueos_claro_3play_dth.aspx.vb" Inherits="rep_rep_porta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <uc1:UCTitulo1 ID="UCTitulo11" runat="server" Titulo="Reporte por Bloquear Claro 3 Play OutBound DTH" />
...
<tr>
<td>ID Carga </td><td>:</td><td><asp:TextBox ID="txtCarga" runat="server" Width="80px"  ClientIDMode="Static" />

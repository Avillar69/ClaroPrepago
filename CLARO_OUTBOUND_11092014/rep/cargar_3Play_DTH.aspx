<%@ Page Title="Claro Inbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="cargar_3Play_DTH.aspx.vb" Inherits="rep_cargar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <uc1:UCTitulo1 ID="UCTitulo11" runat="server" 
            Titulo="Carga Base Claro 3 PLAY DTH" />

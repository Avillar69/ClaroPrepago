...
Partial Class rep_rep_porta
    ...
    Protected Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            Dim dtHistorial As DataTable = da.SP_HISTORIAL_CLARO_TV_RECUPERO_2(be)
            If dtHistorial.Rows.Count > 0 Then
                ...
                Dim dtScripting As DataTable = da.SP_LISTAR_TV_RECUPERO_2(IDS)
    ...
    Sub EXPORTAR()
        ...
        Dim nombre As String = "Tv Recupero 2"
    ...
    Sub ExportarTxt()
        ...
        Response.Clear()
        Response.AddHeader("content-disposition", "attachment;filename=TvRecupero2.csv")
        Response.Charset = ""

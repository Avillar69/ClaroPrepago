<%@ Page Title="Claro Inbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="cargar_recupero_fisica.aspx.vb" Inherits="rep_cargar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <uc1:UCTitulo1 ID="UCTitulo11" runat="server" Titulo="Carga Base Recupero Física" />

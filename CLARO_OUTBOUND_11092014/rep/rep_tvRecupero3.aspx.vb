...
Partial Class rep_rep_porta
    ...
    Protected Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            Dim dtHistorial As DataTable = da.SP_HISTORIAL_CLARO_TV_RECUPERO_3(be)
            If dtHistorial.Rows.Count > 0 Then
                ...
                Dim dtScripting As DataTable = da.SP_LISTAR_TV_RECUPERO_3(IDS)
    ...
    Sub ExportarTxt()
        ...
        Response.Clear()
        Response.AddHeader("content-disposition", "attachment;filename=TvRecupero3.csv")
        Response.Charset = ""

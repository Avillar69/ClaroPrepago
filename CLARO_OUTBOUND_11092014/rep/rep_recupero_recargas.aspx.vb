...
Partial Class rep_rep_porta
    ...
    Protected Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            Dim dtHistorial As DataTable = da.SP_HISTORIAL_CLARO_RECUPERO_RECARGAS(be)
            If dtHistorial.Rows.Count > 0 Then

                dtHistorial.Columns.Add("CBO_NO_REALIZO_RECARGA", Type.GetType("System.String"))
                dtHistorial.Columns.Add("TXT_OPERADOR", Type.GetType("System.String"))
                dtHistorial.Columns.Add("TXT_XQ_DARA_BAJA", Type.GetType("System.String"))
                dtHistorial.Columns.Add("DTP_REALIZARA_RECARGA", Type.GetType("System.String"))
                ...
                Dim dtScripting As DataTable = da.SP_LISTAR_RECUPERO_RECARGAS(IDS)
                ...
                For i = 0 To dtHistorial.Rows.Count - 1
                    ...
                    For j = 0 To dtScripting.Rows.Count - 1
                        ...
                        If IDScrip = IDhIS Then
                            ...
                            dtHistorial.Rows(i)("CBO_NO_REALIZO_RECARGA") = dtScripting.Rows(j)("XQ_NO_REALIZO_RECARGA").ToString
                            dtHistorial.Rows(i)("TXT_OPERADOR") = dtScripting.Rows(j)("QUE_OPERADOR").ToString
                            dtHistorial.Rows(i)("TXT_XQ_DARA_BAJA") = dtScripting.Rows(j)("XQ_DARA_BAJA").ToString
                            dtHistorial.Rows(i)("DTP_REALIZARA_RECARGA") = dtScripting.Rows(j)("REALIZARA_RECARGA").ToString
    ...
    Sub EXPORTAR()
        ...
        Dim nombre As String = "Recupero Recargas"

...
Partial Class rep_cargar
    ...
    End Sub
    Sub GUARDAR()
        Dim dtId As DataTable = da.MAXIMO_ID_3PLAY()
        Dim id As Integer = 0
        ...
        If dtId.Rows.Count > 0 Then
            ...
            If dt.Rows.Count > 0 Then
                For i = 0 To dt.Rows.Count - 1
                    ...
                    be.VAR_CLIENTE = dt.Rows(i)("CODIGO_CLIENTE").ToString
                    be.VAR_D_NOMBRE_CLIENTE = dt.Rows(i)("NOMBRE_CLIENTE").ToString
                    be.VAR_D_SOLICITUD = dt.Rows(i)("SOLUCION").ToString
                    ...
                    be.VAR_PROYECTO = dt.Rows(i)("PROYECTO").ToString
                    be.VAR_D_NRO_DOCUMENTO = dt.Rows(i)("NRO_DOCUMENTO").ToString
                    be.VAR_SERVICEID = dt.Rows(i)("SERVICIO").ToString
                    be.VAR_REFERENCIA = dt.Rows(i)("REFERENCIA").ToString
                    be.VAR_DEPARTAMENTO = dt.Rows(i)("DEPARTAMENTO").ToString
                    be.VAR_FECH_INSTALACION = dt.Rows(i)("FEC_INSTALACION").ToString
                    be.VAR_PROVINCIA = dt.Rows(i)("PROVINCIA").ToString

                    '
                    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                    Dim ms As String = da.SP_REGISTRAR_BASE_SCRIPTING_OUTBOUND_3PLAY(be)
                    Select Case ms
                        Case "0"
                            c_no_bien += 1
                        Case "1"

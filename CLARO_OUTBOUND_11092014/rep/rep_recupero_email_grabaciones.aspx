<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="rep_recupero_email_grabaciones.aspx.vb" Inherits="rep_rep_porta" %>

<%@ Register Src="../DynamicData/FieldTemplates/UCTitulo1.ascx" TagName="UCTitulo1"
    TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="../jquery_smoothness/js/jquery-1.9.1.js" type="text/javascript"></script>
    <link href="../jquery_smoothness/css/smoothness/jquery-ui-1.10.3.custom.min.css"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <table align="left">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="cboFecha" runat="server">
                    </asp:DropDownList>
                </td>
                <td>
    ...
    <div>
        <asp:Panel ID="pn" runat="server" ScrollBars="Auto" Height="350px">
            <asp:LinkButton ID="lnkExportar" runat="server" Visible="false">Exportar</asp:LinkButton>
            <asp:GridView ID="grvReporte" runat="server" CssClass="gridview" RowStyle-Wrap="false"

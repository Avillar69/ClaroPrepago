...
Partial Class rep_rep_porta
    ...
    Protected Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Else
            ...
            Try
                ...
                Dim dt1 As DataTable = da.SP_CLARO_3PLAY_DTH_BLOQUEO_P1(be)
                ...
                If dt1.Rows.Count > 0 Then
                    ...
                    be.VAR_IDS = IDS
                    Dim dt2 As DataTable = da.SP_CLARO_3PLAY_DTH_BLOQUEO_P2(be)
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        Dim dt3 As DataTable = da.SP_CLARO_3PLAY_DTH_BLOQUEO_P3(be)
                        ...
                        If dt3.Rows.Count > 0 Then
                            ...
                            Dim dt4 As DataTable = da.SP_CLARO_3PLAY_DTH_BLOQUEO_P4(be)
    ...
    Sub ExportarTxt()
        ...
        Response.Clear()
        Response.AddHeader("content-disposition", "attachment;filename=BLOQ_CLARO_3PLAY_DTH" & fileT & ".csv")
        Response.Charset = ""

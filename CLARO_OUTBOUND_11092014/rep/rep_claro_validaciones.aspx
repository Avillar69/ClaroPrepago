<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_claro_validaciones.aspx.vb" Inherits="rep_rep_porta" %>
...
<div>
   <asp:Panel ID="pn" runat="server" ScrollBars="Auto" Height="500px">
       ...
       &nbsp;&nbsp;<asp:GridView ID="grvReporte" runat="server" CssClass="gridview"  
           ...
           RowStyle-Wrap="false" PageSize="30">
    </asp:GridView>

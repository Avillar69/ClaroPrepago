<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_seg_clientes_top2.aspx.vb" Inherits="rep_rep_porta2" %>
...
<div>
   <asp:Panel ID="pn" runat="server" ScrollBars="Auto" Height="350px">
       ...
       <asp:GridView ID="grvReporte" runat="server" CssClass="rounded_corners" 
           AutoGenerateColumns="true" AllowPaging="True"  RowStyle-Wrap="false" HeaderStyle-Wrap = "false"
               PageSize="50">
    </asp:GridView>

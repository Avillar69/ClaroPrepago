...
Partial Class rep_cargar
    ...
    Sub CargarExcel(ByVal SLibro As String)
        ...
        Try
            ...
            If Not System.IO.File.Exists(SLibro) Then
                lblMsg.Text = ("No se encontró el Libro: " & _
                                        SLibro & "Ruta inválida")
                Exit Sub
            End If
    ...
    End Sub
    Sub GUARDAR()
        Dim dtId As DataTable = da.MAXIMO_ID_RECUPERO_FISICA
        Dim id As Integer = 0
        ...
        If dtId.Rows.Count > 0 Then
            ...
            If dt.Rows.Count > 0 Then
                For i = 0 To dt.Rows.Count - 1
                    id += 1
                    be.VAR_ID = id
                    be.VAR_CUENTA = dt.Rows(i)("CUST_ID").ToString
                    be.VAR_CICLO = dt.Rows(i)("CICLO").ToString
                    be.VAR_RAZON_SOCIAL = dt.Rows(i)("RAZON_SOCIAL").ToString
                    be.VAR_D_NOMBRE_CLIENTE = dt.Rows(i)("NOMBRE").ToString
                    be.VAR_DIRECCION = dt.Rows(i)("DIRECCION").ToString
                    be.VAR_REFERENCIA = dt.Rows(i)("REFERENCIA").ToString
                    ...
                    be.VAR_D_TELEF_MOVIL = dt.Rows(i)("MOVIL_CLARO").ToString
                    be.VAR_REFERENCIA_1 = dt.Rows(i)("REFERENCIA_1").ToString
                    be.VAR_REFERENCIA_2 = dt.Rows(i)("REFERENCIA_2").ToString
                    be.VAR_PLAN = dt.Rows(i)("PLAN").ToString
                    be.VAR_DNI = dt.Rows(i)("DNI").ToString

                    'be.VAR_RESPONSABLE = Session("usuario")
                    Dim ms As String = da.SP_REGISTRAR_BASE_SCRIPTING_OUT_RECUPERO_FISICO(be)
                    Select Case ms
                        Case "0"
                            c_no_bien += 1
                        Case "1"
                            ...
                            If Not IsNumeric(be.VAR_D_TELEF_MOVIL) Then telefono1 = "" Else telefono1 = CInt(be.VAR_D_TELEF_MOVIL)
                            ...
                            If Not IsNumeric(be.VAR_REFERENCIA_1) Then telefono2 = "" Else telefono2 = CInt(be.VAR_REFERENCIA_1)
                            ...
                            If Not IsNumeric(be.VAR_REFERENCIA_2) Then telefono3 = "" Else telefono3 = CInt(be.VAR_REFERENCIA_2)
    ...
    Sub ExportarTxt()
        ...
        Response.Clear()
        Response.AddHeader("content-disposition", "attachment;filename=BASE_RECUPERO_FISICA.csv")
        Response.Charset = ""

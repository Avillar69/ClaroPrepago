<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_ranking_recupero_out.aspx.vb" Inherits="rep_rep_porta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <uc1:UCTitulo1 ID="UCTitulo11" runat="server" Titulo="Reporte Ranking Claro Recupero Outbound" />
...
<tr><td><p>ID Login</p></td><td>:</td><td><asp:DropDownList ID="cboLog" runat="server" CssClass="btn btn-default btn-sm dropdown-toggle"></asp:DropDownList></td></tr>
...
<table>
    <tr><td>
    <asp:Label ID="lblUsuario" runat="server" Text="Usuario" Visible = "false"></asp:Label>:</td><td>
    <asp:TextBox ID="txtUsu" runat="server" CssClass="form-control input-sm" ReadOnly="true" Font-Bold="true" Visible = "false" Width = "250px"></asp:TextBox>
    </td></tr>    
</table>

    <br />
       <asp:LinkButton ID="lnkExportar" runat="server" class="btn btn-default btn-sm" Visible="false" OnClick="ExportToExcel" >
        <span class="glyphicon glyphicon-download-alt"> </span> &nbsp;Exportar Detalle
       </asp:LinkButton>

       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

       <asp:LinkButton ID="lnkExportarRes" runat="server" class="btn btn-default btn-sm" Visible="false" OnClick="ExportToExcelRes" >
       <span class="glyphicon glyphicon-download-alt"></span> &nbsp;Exportar Cuadro resumen
       </asp:LinkButton>
       <br />

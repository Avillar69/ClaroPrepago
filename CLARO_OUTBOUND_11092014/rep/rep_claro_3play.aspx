<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_claro_3play.aspx.vb" Inherits="rep_rep_porta" %>
...
<div>
   <asp:Panel ID="pn" runat="server" ScrollBars="Auto" Height="500px">
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <asp:LinkButton ID="lnkExportarCsv" runat="server" Visible="false">Exportar CSV</asp:LinkButton>
    <asp:GridView ID="grvReporte" runat="server" CssClass="gridview"  AutoGenerateColumns="true" AllowPaging="True" RowStyle-Wrap="false" PageSize="50">
    </asp:GridView>
    ...
    <br />
      ...
      <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" Height="500px">
       <asp:LinkButton ID="LinkButton1" runat="server" Visible="false">Exportar Excel</asp:LinkButton>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <asp:LinkButton ID="LinkButton2" runat="server" Visible="false">Exportar CSV</asp:LinkButton>
    <asp:GridView ID="grvReporte2" runat="server" CssClass="gridview" RowStyle-Wrap="false" PageSize="50">
    </asp:GridView>

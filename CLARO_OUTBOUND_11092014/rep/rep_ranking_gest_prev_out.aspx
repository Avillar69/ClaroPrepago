<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_ranking_gest_prev_out.aspx.vb" Inherits="rep_rep_porta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <uc1:UCTitulo1 ID="UCTitulo11" runat="server" Titulo="Reporte Ranking Claro Gestion Preventiva Outbound" />

</div>
<div>

<table>
<tr><td><p>Inicio</p></td><td>:</td><td><asp:TextBox ID="txtInicio" runat="server"  CssClass="form-control input-sm"  ClientIDMode="Static" />&nbsp;&nbsp;&nbsp;&nbsp; </td>

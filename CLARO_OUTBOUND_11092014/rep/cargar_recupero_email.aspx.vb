...
Partial Class rep_cargar
    ...
    End Sub
    Sub GUARDAR()
        Dim dtId As DataTable = da.MAXIMO_ID_RECUPERO_ELECTRONICO
        Dim id As Integer = 0
        ...
        If dtId.Rows.Count > 0 Then
            ...
            If dt.Rows.Count > 0 Then
                For i = 0 To dt.Rows.Count - 1
                    ...
                    be.VAR_EMAIL_ERRADO = dt.Rows(i)("EMAIL_ERRADO").ToString
                    ...
                    Dim ms As String = da.SP_REGISTRAR_BASE_SCRIPTING_OUT_RECUPERO_ELECTRONICO(be)
                    'Dim ms As String = "1"
                    Select Case ms
                        Case "0"
                            c_no_bien += 1
                        Case "1"
                            ...
                            If Not IsNumeric(be.VAR_TELCELULAR) Then telefono1 = "" Else telefono1 = CInt(be.VAR_TELCELULAR)
                            ...
                            If Not IsNumeric(be.VAR_TEL1) Then telefono2 = "" Else telefono2 = CInt(be.VAR_TEL1)
                            ...
                            If Not IsNumeric(be.VAR_TEL2) Then telefono3 = "" Else telefono3 = CInt(be.VAR_TEL2)
    ...
    Sub ExportarTxt()
        ...
        Response.Clear()
        Response.AddHeader("content-disposition", "attachment;filename=BASE_RECUPERO_ELECTRONICO.csv")
        Response.Charset = ""

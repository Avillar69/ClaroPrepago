<%@ Page Title="Claro Inbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="cargar_afiliacion_ce.aspx.vb" Inherits="rep_cargar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <uc1:UCTitulo1 ID="UCTitulo11" runat="server" Titulo="Carga Base Migraciones" />
...
<tr>
<td colspan="3" >
    <asp:Button ID="btnVisualizar" runat="server" Text="Visualizar" Width="150px" /><br /><br />
    <asp:Button ID="btnGenerar" runat="server" Text="Generar" Width="150px" Visible="false" />
    </td>
</tr>
</table>
</div>
...
<div>
   <asp:Panel ID="pn" runat="server" ScrollBars="Auto">
    ...
    <asp:GridView ID="grvCarga" runat="server" CssClass="gridview"  RowStyle-Wrap="false">
    </asp:GridView>
   </asp:Panel>
</div>
<div>

...
Partial Class rep_rep_porta
    ...
    Protected Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            Dim dtHistorial As DataTable = da.SP_HISTORIAL_CLARO_AFILIACION_CE(be)
            If dtHistorial.Rows.Count > 0 Then
                ...
                Dim dtScripting As DataTable = da.SP_LISTAR_CLARO_AFILIACION_RCE(IDS)
    ...
    Sub EXPORTAR()
        ...
        Dim nombre As String = "Afiliacion_CE"
    ...
    Sub ExportarTxt()
        ...
        Dim i As Integer
        str.Append("ID_LOG, FECHA, LOADID, ID, ID_FINAL, FINAL, LOGIN, TELEFONO, TALKTIME, ACWTIME,D_CUENTA,D_CLIENTE,D_CONTACTO,D_DEPARTAMENTO,D_PROVINCIA,D_DISTRITO,D_TELEFONO_1,D_TELEFONO_2,D_TELEF_CELULAR,D_PLAN,D_DNI,D_EMAIL_ERRADO,D_CICLO_FACT,CBO_ACEPTA,TXT_EMAIL,CBO_DOMINIO_MAIL,TXT_EMAIL_COMPLETO,TXT_MOTIVO_NO_ACT,CBO_TIPO_CONTACTO,CBO_RESULTADO,TXT_REFERENCIA")
        ...
        Response.Clear()
        Response.AddHeader("content-disposition", "attachment;filename=Afiliacion_CE.csv")
        Response.Charset = ""

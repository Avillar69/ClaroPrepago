<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_cancel.aspx.vb" Inherits="rep_rep_porta" %>
...
<tr>
<td>Finales</td><td>:</td><td>
    <asp:DropDownList ID="ddlFinales" runat="server">

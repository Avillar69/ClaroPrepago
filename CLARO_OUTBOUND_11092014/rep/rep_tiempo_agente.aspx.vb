...
Partial Class rep_rep_porta
    ...
    Dim arr_serv() As String = {"Seleccionar", "Seguimiento Clientes TOP", "Seguimiento Clientes Especiales", "Negociación deuda Clientes TOP"}
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            cboServicio.DataSource = arr_serv
    ...
    Protected Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            If cboServicio.SelectedIndex = 0 Then
                lblMsg.Text = "Seleccionar un servicio"
                lblMsg.CssClass = "alert alert-danger"
            ElseIf cboServicio.SelectedIndex = 1 Then
                serv = 2013
            ElseIf cboServicio.SelectedIndex = 2 Then
                serv = 2018
            ElseIf cboServicio.SelectedIndex = 3 Then
                serv = 2021
            End If
            be.inicio = txtInicio.Text
            be.fin = txtFin.Text
            be.VAR_SERVICIO = serv.ToString()
            'be.VAR_USUARIO = Session("usuario")

            Dim dtHistorial As DataTable = da.SP_TIEMPO_AGENTE_INICIO_FIN_OUTBOUND(be)
            ...
            Else
                'lnkExportar1.Visible = False
                lnkExportar2.Visible = False
                lblMsg.Text = "SIN REGISTROS CON LOS PARAMETROS DE BUSQUEDA"
                lblMsg.CssClass = "alert alert-danger"

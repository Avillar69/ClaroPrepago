<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_claro_encpre.aspx.vb" Inherits="rep_rep_claro_encpre" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <uc1:UCTitulo1 ID="UCTitulo11" runat="server" Titulo="Reporte Claro Encuesta Prepago" />
    </div>
...
<br /><br />
   ...
   <asp:Panel ID="pn" runat="server" ScrollBars="Auto" Height="300px">
        ...
        <asp:GridView ID="grvReporte" runat="server" CssClass="rounded_corners" 
               AutoGenerateColumns="true"   RowStyle-Wrap="TRUE"  
              >
        </asp:GridView>

<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_migraciones.aspx.vb" Inherits="rep_re_general_migraciones" %>
...
<div>
   <asp:Panel ID="pn" runat="server" ScrollBars="Auto" Height="300px">
    ...
    <asp:GridView ID="grvReporte3" runat="server" CssClass="gridview"  
           RowStyle-Wrap="false" AutoGenerateColumns="False" Visible="False">
        <Columns>
            <asp:BoundField DataField="FECHAHORA" HeaderText="FECHAHORA" />
            <asp:BoundField DataField="IDBASE" HeaderText="IDBASE" />
            <asp:BoundField DataField="IDCALLCENTER" HeaderText="IDCALLCENTER" />

    ...
    Protected Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            If dtHistorial.Rows.Count > 0 Then
                ...
                dtHistorial.Columns.Add("UPSELL CAMPANIA", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL CLIENTE", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL DNI", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL PLAN OFRECIDO", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL MARCA", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL TOME CONSUMO", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL PAGO EQUIPO", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL PRECIO EQUIPO", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL FECHA NACIMIENTO", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL LUGAR NACIMIENTO", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL CORREO", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL CICLO FACTURA", Type.GetType("System.String"))
                dtHistorial.Columns.Add("UPSELL PLAZO CONTRATO", Type.GetType("System.String"))
                ...
                For i = 0 To dtHistorial.Rows.Count - 1
                    ...
                    For j = 0 To dtScripting.Rows.Count - 1
                        ...
                        If IDScrip = IDhIS Then
                            ...
                            dtHistorial.Rows(i)("UPSELL CAMPANIA") = dtScripting.Rows(j)("UPSELL CAMPANIA").ToString
                            dtHistorial.Rows(i)("UPSELL CLIENTE") = dtScripting.Rows(j)("UPSELL CLIENTE").ToString
                            dtHistorial.Rows(i)("UPSELL PLAN OFRECIDO") = dtScripting.Rows(j)("UPSELL PLAN OFRECIDO").ToString
                            dtHistorial.Rows(i)("UPSELL MARCA") = dtScripting.Rows(j)("UPSELL MARCA").ToString
                            dtHistorial.Rows(i)("UPSELL TOME CONSUMO") = dtScripting.Rows(j)("UPSELL TOME CONSUMO").ToString
                            dtHistorial.Rows(i)("UPSELL PAGO EQUIPO") = dtScripting.Rows(j)("UPSELL PAGO EQUIPO").ToString
                            dtHistorial.Rows(i)("UPSELL PRECIO EQUIPO") = dtScripting.Rows(j)("UPSELL PRECIO EQUIPO").ToString
                            dtHistorial.Rows(i)("UPSELL FECHA NACIMIENTO") = dtScripting.Rows(j)("UPSELL FECHA NACIMIENTO").ToString
                            dtHistorial.Rows(i)("UPSELL LUGAR NACIMIENTO") = dtScripting.Rows(j)("UPSELL LUGAR NACIMIENTO").ToString
                            dtHistorial.Rows(i)("UPSELL CORREO") = dtScripting.Rows(j)("UPSELL CORREO").ToString
                            dtHistorial.Rows(i)("UPSELL CICLO FACTURA") = dtScripting.Rows(j)("UPSELL CICLO FACTURA").ToString
                            dtHistorial.Rows(i)("UPSELL PLAZO CONTRATO") = dtScripting.Rows(j)("UPSELL PLAZO CONTRATO").ToString

...
Partial Class rep_rep_porta
    ...
    Protected Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            Dim dtHistorial As DataTable = da.SP_HISTORIAL_CLARO_3PLAY_DTH(be)
            If dtHistorial.Rows.Count > 0 Then
                ...
                dtHistorial.Columns.Add("D_FEC_NAC", Type.GetType("System.String"))
                ...
                dtHistorial.Columns.Add("D_CF_TOTAL", Type.GetType("System.String"))
                dtHistorial.Columns.Add("D_NRO_SOT", Type.GetType("System.String"))
                ...
                Session("ids") = IDS
                Dim dtScripting As DataTable = da.SP_LISTAR_CLARO_3PLAY_DTH(IDS)
                ...
                For i = 0 To dtHistorial.Rows.Count - 1
                    ...
                    dtHistorial.Rows(i)("D_FEC_NAC") = row(4)
                    dtHistorial.Rows(i)("D_NRO_DOCUMENTO") = row(5)
                    dtHistorial.Rows(i)("D_DIRECCION") = row(6)
                    dtHistorial.Rows(i)("D_DISTRITO") = row(7)
                    dtHistorial.Rows(i)("D_PROVINCIA") = row(8)
                    dtHistorial.Rows(i)("D_DEPARTAMENTO") = row(9)
                    dtHistorial.Rows(i)("D_TELEFONO_01") = row(10)
                    dtHistorial.Rows(i)("D_TELEFONO_02") = row(11)
                    dtHistorial.Rows(i)("D_TELEFONO_03") = row(12)
                    dtHistorial.Rows(i)("D_TELEFONO_04") = row(13)
                    dtHistorial.Rows(i)("D_TELEFONO_05") = row(14)
                    dtHistorial.Rows(i)("D_CAMPANIA") = row(15)
                    dtHistorial.Rows(i)("D_CF_TOTAL") = row(16)
                    dtHistorial.Rows(i)("D_NRO_SOT") = row(17)
                    dtHistorial.Rows(i)("D_FEC_ACTIVACION") = row(18)
                    dtHistorial.Rows(i)("D_MATERIAL_DES") = row(19)
                    dtHistorial.Rows(i)("D_PLAN_TARIFARIO") = row(20)
                    dtHistorial.Rows(i)("CBO_PRODUCTO") = row(21)
                    dtHistorial.Rows(i)("CBO_TIPO") = row(22)
                    dtHistorial.Rows(i)("CBO_TIPO_LLAMADA") = row(23)
                    dtHistorial.Rows(i)("CBO_SUBTIPO_LLAMADA") = row(24)
                    dtHistorial.Rows(i)("CBO_PROB_TECNICO") = row(25)
                    dtHistorial.Rows(i)("CBO_NO_CONFORME") = row(26)
                    dtHistorial.Rows(i)("CBO_INFORMACION") = row(27)
                    dtHistorial.Rows(i)("CBO_SOLICITUD_PEN") = row(28)
                    dtHistorial.Rows(i)("CBO_TV") = row(29)
                    dtHistorial.Rows(i)("CBO_RECIBO") = row(30)
                    dtHistorial.Rows(i)("CBO_ESTADO_PAGO") = row(31)
                    dtHistorial.Rows(i)("CBO_ESTADO_RECIBO") = row(32)
                    dtHistorial.Rows(i)("TXT_CORREO") = row(33)
                    dtHistorial.Rows(i)("CBO_AFILIA_RECIBO_ELEC") = row(34)
                    dtHistorial.Rows(i)("TXT_PORQUE_NO") = row(35)
                    dtHistorial.Rows(i)("CBO_REALIZA_DESCARTE_ADM") = row(36)
                    dtHistorial.Rows(i)("CBO_DETECTA_PROB_ADM") = row(37)
                    dtHistorial.Rows(i)("CBO_NO_DETEC_PROB_ADM") = row(38)
                    dtHistorial.Rows(i)("CBO_FRENTE_A_EQ") = row(39)
                    dtHistorial.Rows(i)("CBO_NO_FRENTE_A_EQ") = row(40)
                    dtHistorial.Rows(i)("TXT_CODIGO") = row(41)
                    dtHistorial.Rows(i)("TXT_NOM_CLI") = row(42)
                    dtHistorial.Rows(i)("TXT_NRO_NOM_CONTACTO") = row(43)
                    dtHistorial.Rows(i)("CBO_SERVI_AFECTADO") = row(44)
                    dtHistorial.Rows(i)("TXT_CAMBIO_EQ") = row(45)
                    dtHistorial.Rows(i)("TXT_HORARIO_LLAMADA") = row(46)
                    dtHistorial.Rows(i)("DTP_FEC_INSTALACION") = row(47)
                    dtHistorial.Rows(i)("TXT_OBSERVACION") = row(48)
                    dtHistorial.Rows(i)("TXT_PROB_TEC_CORREO") = row(49)
                Next
    ...
    Sub EXPORTAR1()
        ...
        Dim nombre As String = "Unicos 3 Play DTH" & Now.ToString("yyyyMMddHHmmss")
    ...
    Sub EXPORTAR2()
        ...
        Response.Clear()
        Response.Buffer = True
        Dim nombre As String = "Detalle_3_Play_DTH_" & Now.ToString("yyyyMMddHHmmss")
        Response.ContentType = "application/vnd.ms-excel"

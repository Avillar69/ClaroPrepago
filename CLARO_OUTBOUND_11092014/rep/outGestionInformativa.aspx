<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="outGestionInformativa.aspx.vb" Inherits="rep_outGestionInformativa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 <div>
        ...
        <uc1:UCTitulo1 ID="UCTitulo11" runat="server" 
            Titulo="Carga Base Gestión Informativa" />

<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_renovaciones_ranking.aspx.vb" Inherits="rep_rep_porta" %>
...
<div>
   <asp:Panel ID="pn" runat="server" ScrollBars="Auto" Height="500px">
    <asp:GridView ID="grvReporte" runat="server" CssClass="gridview" 
        ...
        <Columns>
            <asp:BoundField DataField="LOGIN_AGENTE" HeaderText="LOGIN" />
            ...
            <asp:BoundField DataField="RECUPERABLE" HeaderText="RECUPERABLE" />
            <asp:BoundField DataField="DESAPROBADO" HeaderText="DESAPROBADO" />

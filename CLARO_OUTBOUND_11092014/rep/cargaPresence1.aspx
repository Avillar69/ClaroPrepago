<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="cargaPresence1.aspx.vb" Inherits="rep_cargaPresence1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <uc1:UCTitulo1 ID="UCTitulo11" runat="server" 
            Titulo="Carga Base CLARO 3 PLAY HFC" />
...
<table align="left">
<tr>
<td>Recupero</td><td>:</td><td>
    <asp:DropDownList ID="ddlrecupero" Width="130px" runat="server">
    </asp:DropDownList>
    </td>
</tr>
<tr>
...
<asp:GridView ID="grvCamp" runat="server" CssClass="gridview"  RowStyle-Wrap="false">
    </asp:GridView>
    </asp:Panel>
</td></tr><tr><td>
   <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
    <asp:LinkButton ID="lnkExportar" runat="server" Visible="false">Exportar</asp:LinkButton>
    <asp:GridView ID="grvMostrar" runat="server" CssClass="gridview"  
           RowStyle-Wrap="false" AllowPaging="True" PageSize="30">
    </asp:GridView>
    </asp:Panel>
</td>
</tr>

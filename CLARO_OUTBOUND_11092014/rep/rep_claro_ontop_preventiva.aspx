<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_claro_ontop_preventiva.aspx.vb" Inherits="rep_rep_porta" %>
...
<tr>
<td>Servicio</td><td>:</td><td>
    <asp:DropDownList ID="CBO_SERVICIO" runat="server">
        <asp:ListItem>SELECCIONAR</asp:ListItem>
        <asp:ListItem>176 (19 K )</asp:ListItem>
        <asp:ListItem>191 ( 5 K )</asp:ListItem>
    </asp:DropDownList>
&nbsp;
    <asp:Button ID="btnBuscar" runat="server" Text="Consultar" Height="26px" />
    </td>
</tr>
</table>
</div>
...
<div>
   <asp:Panel ID="pn" runat="server" ScrollBars="Auto" Height="500px">
    ...
    <asp:GridView ID="grvReporte" runat="server" CssClass="gridview"  AutoGenerateColumns="true" AllowPaging="True"

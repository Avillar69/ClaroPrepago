<%@ Page Title="Claro Outbound" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="rep_cancel_consulta_telef.aspx.vb" Inherits="rep_rep_porta" %>
...
<tr>
<td>Telefono</td><td>:</td><td><asp:TextBox ID="txtTelefono" runat="server" 
...
<div>
   <asp:Panel ID="pn" runat="server" ScrollBars="Auto" Height="500px">
    <asp:GridView ID="grvReporte" runat="server" CssClass="gridview" RowStyle-Wrap="false" PageSize="10">
    </asp:GridView>
   </asp:Panel>
</div>
</asp:Content>

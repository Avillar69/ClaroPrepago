...
Partial Class rep_rep_porta
    ...
    Protected Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            Dim dtHistorial As DataTable = da.SP_HISTORIAL_CLARO_RECUPERO_LLAMANOMAS(be)
            If dtHistorial.Rows.Count > 0 Then
                ...
                Dim dtScripting As DataTable = da.SP_LISTAR_RECUPERO_LLAMANOMAS(IDS)
    ...
    Sub EXPORTAR()
        ...
        Dim nombre As String = "Recupero Llamanomas"
